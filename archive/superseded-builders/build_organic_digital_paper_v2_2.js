#!/usr/bin/env node
// ══════════════════════════════════════════════════════════════════════════════
// Organic Digital Loudspeakers v2.2 — Complete 25-Year Journey + OCC Drift Refinement
...
function titlePage() {
  return [
    ...
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 60 },
      children: [new TextRun({ text: 'Version 2.1', font: 'Times New Roman', size: 20, italics: true, color: MTEAL })] }),
...
async function build() {
  const header = new Header({
    children: [new Paragraph({
      ...
      children: [
        ...
        new TextRun({ text: '\tOrganic Digital Loudspeakers v2.1', font: 'Times New Roman', size: 18, italics: true, color: MTEAL }),
      ],
  ...
  const outPath = __dirname + '/Organic_Digital_Loudspeakers_v2.2.docx';
  ...
  console.log(`   Sections: 15 + References + Title + Dedication + Abstract`);
