#!/usr/bin/env node
// ══════════════════════════════════════════════════════════════════════════════
// Organic Digital Loudspeakers v2.3 — Complete 25-Year Journey + Adaptive Scope
...
function titlePage() {
  return [
    ...
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 60 },
      children: [new TextRun({ text: 'Version 2.3', font: 'Times New Roman', size: 20, italics: true, color: MTEAL })] }),
...
async function build() {
  const header = new Header({
    children: [new Paragraph({
      ...
      children: [
        ...
        new TextRun({ text: '\tOrganic Digital Loudspeakers v2.3', font: 'Times New Roman', size: 18, italics: true, color: MTEAL }),
      ],
  ...
  const outPath = __dirname + '/Organic_Digital_Loudspeakers_v2.3.docx';
  ...
  console.log(`   Sections: 16 + References + Title + Dedication + Abstract`);
