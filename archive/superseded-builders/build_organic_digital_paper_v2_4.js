#!/usr/bin/env node
// ══════════════════════════════════════════════════════════════════════════════
// Organic Digital Loudspeakers v2.4 + HUF-Org — Complete 25-Year Journey + Living System
...
function section17() {
  return [
    ...
    crossRef('See HUF Sufficiency Frontier v3.4 §11: HUF-Org as Metabolic Boundary'),
    crossRef('See HUF Fourth Category v2.4 §12: MC-4 as Immune System'),
...
async function build() {
  const header = new Header({
    children: [new Paragraph({
      ...
      children: [
        ...
        new TextRun({ text: '\tOrganic Digital Loudspeakers v2.4 + HUF-Org', font: 'Times New Roman', size: 18, italics: true, color: MTEAL }),
      ],
  ...
  const outPath = __dirname + '/Organic_Digital_Loudspeakers_v2.4.docx';
  ...
  console.log(`   Sections: 17 + References + Title + Dedication + Abstract`);
